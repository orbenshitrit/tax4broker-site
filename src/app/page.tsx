...
const faqs = [
  ...
  {
    q: "סיימתי את התהליך וקיבלתי ממכם טפסי 1322 ו-1325. האם אני צריך לחתום עליהם?",
    a: "לא. אין חובה לחתום על טופס 1322 בנפרד, משום שהטופס מצורף לדוח השנתי טופס 1301. כאשר חותמים על דוח 1301 — האישור כולל גם את טופס 1322 וכל הנספחים המצורפים (הנחיה קיימת משנת 2019).",
  },
];
